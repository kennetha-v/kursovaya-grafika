...
ObjFile chick1, chick2a, chick2b, chick3, scene, sign, nest, house, edge, skybox;

Texture chickTex, sceneTex, signTex, nestTex, houseTex, edgeTex, skyboxTex;
...
//	loadModel("models\\1k.obj_m", &objModel);


	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\chicken_1k.obj_m", &chick1);
	chickTex.loadTextureFromFile("textures//chicken.bmp");
	chickTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\scene_k.obj_m", &scene);
	sceneTex.loadTextureFromFile("textures//scene.bmp");
	sceneTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\sign_k.obj_m", &sign);
	signTex.loadTextureFromFile("textures//sign.bmp");
	signTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\nest_k.obj_m", &nest);
	nestTex.loadTextureFromFile("textures//nest.bmp");
	nestTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\house_k.obj_m", &house);
	houseTex.loadTextureFromFile("textures//house.bmp");
	houseTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\edge_k.obj_m", &edge);
	edgeTex.loadTextureFromFile("textures//edge.bmp");
	edgeTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\skybox_k.obj_m", &skybox);
	skyboxTex.loadTextureFromFile("textures//skybox.bmp");
	skyboxTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\chicken_2ak.obj_m", &chick2a);
	chickTex.loadTextureFromFile("textures//chicken.bmp");
	chickTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\chicken_2bk.obj_m", &chick2b);
	chickTex.loadTextureFromFile("textures//chicken.bmp");
	chickTex.bindTexture();

	glActiveTexture(GL_TEXTURE0);
	loadModel("models\\chicken_3k.obj_m", &chick3);
	chickTex.loadTextureFromFile("textures//chicken.bmp");
	chickTex.bindTexture();
